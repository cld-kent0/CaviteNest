...
const getPaymentLink = (planType: string, billingPeriod: string, paymentMethod: string) => {
            ...
            >
                <div className="relative gap-4 mt-4">
                    <button
                        ...
                        className={`px-4 py-4 mt-4 rounded-lg w-full ${selectedPaymentMethod === "stripe" ? "bg-violet-800 text-white border-solid border-2 border-gray-500" : "bg-violet-500 text-white"}`}
                    >
                        Stripe
                    </button>
                    <button
                        onClick={() => setSelectedPaymentMethod("gcash")}
                        className={`px-4 py-4 mt-4 rounded-lg w-full ${selectedPaymentMethod === "gcash" ? "bg-blue-800 text-white border-solid border-2 border-gray-500" : "bg-blue-500 text-white"}`}
                    >
                        GCash
                    </button>
                    {/* <button
